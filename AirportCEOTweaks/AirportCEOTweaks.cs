...
[BepInPlugin("org.airportceotweaks.zeke", PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
[BepInDependency("org.airportceomodloader.humoresque")]
public class AirportCEOTweaks : BaseUnityPlugin
{
    ...
    public static AirportCEOTweaks Instance { get; private set; }
    ...
    private void Awake()
    {
        ...
        AirportCEOTweaksConfig.SetUpConfig();
