...
namespace AirportCEORunways
{
    ...
    public class AirportCEORunways : BaseUnityPlugin
    {
        public const string GUID = "org.airportceorunways.zeke";

        public static AirportCEORunways Instance { get; private set; }
